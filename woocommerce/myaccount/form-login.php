 ...
 <?php endif; ?>
 		...
 		<form method="post" class="login">
 			...
 			<p class="col-md-4">
 				...
 				<button type="submit" class="woocommerce-Button button" name="login" value="<?php esc_attr_e( 'Ok', 'odin'  ); ?>"><?php esc_html_e( 'Ok', 'odin'  ); ?></button>
 			...
 			<p class="col-md-10 woocommerce-LostPassword lost_password">
